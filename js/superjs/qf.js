...
const table = document.getElementById("qualityOfficerTable");
...
function getSelectedRow(){
    ...
    const selected =
    document.querySelector('input[name="quality officer"]:checked');

    if(!selected){
        alert("Please select a quality officer");
        return null;
    }
...
document.getElementById("addBtn").onclick = () => {
    ...
    modalBody.innerHTML = `
        ...
        <button onclick="saveQualityOfficer()">Save quality officer</button>
    `;
};
